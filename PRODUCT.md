...
**Commercial model (decided by the owner, 2026-09-25, replaces 2026-09-22):** three tiers, every price shown with its billing period, annual = 2 months free. **Starter**, $99/month or $990/year: 1 property, twice-daily refreshes (hotel-direct, Booking.com, Expedia), parity alerts, nightly recommendations, manual occupancy + recommended-vs-actual, 90-day history, daily email digest, email support. **Growth** (most popular), $249/month or $2,490/year: up to 5 properties, everything in Starter plus 4× daily refreshes, competitor benchmarking (up to 8 comps), event intelligence with event-impact alerts, Bellhop "ask why", 13-month history, multi-property rollup, priority support. **Enterprise**, custom: 6+ properties, everything in Growth plus PMS integrations (HotelKey, Cloudbeds, Mews), SSO/SAML via Auth0 Organizations, custom comp sets and market benchmarking, dedicated onboarding with quarterly reviews, SLA and phone support. Trial: 14 days, no card, on Growth features with 1 property; the plan is picked at conversion. The phrase "30-day price watch" is retired. No other limit, feature split or tier name may be invented to fill a plan surface. Still open: where Enterprise enquiries go (the landing sends them to /signup).
